	...
	return (
		<main className={mainStyles.main}>
			<div className={mainStyles.sub1}>
				<Image src='/images/image-register.png' width='256px' height='715px' alt='registerimg' />
			</div>
			<div className={mainStyles.sub2}>
				<div className={mainStyles.imagetop}>
					<Image src='/images/registerlogo.png' width='380px' height='127px' alt='registerlogo' />
				</div>
