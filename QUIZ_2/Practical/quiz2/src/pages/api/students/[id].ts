...
import { getOneStudent } from "@/actions/Student";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<ResponseType<Student[]>>) {
    if (req.method === 'GET') {
        ...
        // get the student from the actions
        const cursor = await getOneStudent(client, id);
        ...
        // cast the body as a student (the interface)
        ...
        // add id to student object, mongodb affects
